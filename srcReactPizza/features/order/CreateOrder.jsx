...
function CreateOrder() {
  ...
  // cause this component is wired up with a specific action, this component
  // can access data returned from that action, in case there was no submission!
  // It's for any kind of data, but mainly used for errors:
  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div>
          {/* nice trick to pass some data from the from */}
...
export async function action({ request }) {
  ...
  // we can not call hooks inside this function and can not use useNavigate
