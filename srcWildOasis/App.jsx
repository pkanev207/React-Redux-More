...
// the queryClient sets up the cache behind the scene
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      // the time the cache data is considered fresh - then it is refetch
      // staleTime: 60 * 1000,
      // the data is always stale so whenever we come back to the tab -
      // it will refetch immediately:
      staleTime: 0,
    },
  },
});
